        ...
        <header id="header" class="header header-transparent nav-border">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class=" nav-item  show">
                                <a target="_blank" href="{{ asset('Conference-Brochure.pdf') }}">Program/Sessions</a>
                            </li>
                             @endif
                            <li class=" nav-item  show">
            ...
            <div class="footer-area">
                ...
                <section class="ts-book-seat"
                    style="background-image: url({{ cloudinary_url('nbaconference/bg/bg12', ['width' => 1500]) }})">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="book-seat-content text-center mb-70">
                                    ...
                                    <a class="twitter-timeline" data-width="1000" data-height="500" data-theme="dark"
                                        href="https://twitter.com/NigBarAssoc?ref_src=twsrc%5Etfw">Tweets by
                                        NigBarAssoc</a>
                        ...
                        <div class="ts-footer-newsletter" id="contact-us">
                            <div class="ts-newsletter"
                                style="background-image: linear-gradient(144deg, #141726 51%, #141726 51%, #141726 51%, #141726 51%);  ">
                                <div class="row">
                                    <div class="col-lg-6 mx-auto">
                                        <div class="ts-newsletter-content">
                                            <h2 class="section-title" style="font-size: 20px">
                                                <span>Need help? </span>
                                                With Registration<br> 09166929240
                                            </h2>


                                            <h2 class="section-title" style="font-size: 20px">
                                                <span>OR Email:</span>
                                                info@nbaconference.com
                                            </h2>
                                        </div>
