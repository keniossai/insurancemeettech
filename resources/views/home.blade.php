...
<style>
    ...
    .pricing-tables-area .pricing-box {
        ...
        border-radius: 8px;
        transition: all 0.4s;
        background-image: url({{ cloudinary_url('imt/background/Untitled-1_j3dolx') }});
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-4 col-8">
                            <div class="counter-item">
                                ...
                                <span style="width: 30%">Demos and Masterclasses</span>
                            </div>
                        </div>
                        <div class="col-md-4 col-8">
                            <div class="counter-item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="pricing-box bg-pricing xs-mb30">
                        <div class="pricing-header">
                            <div class="pricing-value">Thematic <br>Areas</div>
                        </div>
                        <div class="pricing-content">
                            <ul>
                                <li>1. Entrance</li>
